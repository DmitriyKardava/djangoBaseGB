...
class TestNewsPage(TestCase):
    fixtures = ("001_user_admin.json", "001_news.json",)
    ...
    def test_create_in_web(self):
        ...
        self.client_with_auth.post(
        path, data={
            "title": "NewTestNews001", "preambule": "NewTestNews001", "body": "NewTestNews001",}, 
        )
...
class TestNewsSelenium(StaticLiveServerTestCase):
    ...
    def setUp(self):
        super().setUp()
        service = Service(executable_path=settings.SELENIUM_DRIVER_PATH_CHROMIUM)
        options = ChromeOptions()
        # options.binary_location = "selenium/chrome-mac-64/Google Chrome for Testing.app"

        self.selenium = WebDriver(service=service, options=options)
    ...
    def test_pick_color(self):
        ...
        try: self.assertEqual(
            ...
            with open(
                "var/screenshots/001_navbar_el_scrnsht.png", "wb" ) as outf:
